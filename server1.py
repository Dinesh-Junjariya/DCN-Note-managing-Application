...
class Client(threading.Thread):
    ...
    def datalink_layer(self,msg):
        ...
        msg = self.get_random_header() + msg
        print(msg)
        print()
        self.physical_layer(msg)
        return

    def network_layer(self,msg):
        net_header = '(NETWORK: ' + "00001010110110011100110001010101)-"
        msg = net_header + msg
        print(msg)
        print()
        self.datalink_layer(msg)
        return

    def transport_layer(self,msg):
        x=bin(port)
        tr_header = "(" + x + 'TRANSPORT)-'
        msg = tr_header + msg
        print(msg)
        print()
        self.network_layer(msg)
        return
    ...
    def session_layer(self,msg):
        ...
        print(msg)
        print()
        self.transport_layer(msg)
        return

    def presentation_layer(self,msg):
        pres_header = '(PRESENTATION TELNET)-'
        msg = pres_header + msg
        print(msg+"\n")
        self.session_layer(msg)
        return

    def application_layer(self,msg):
        msg = '(APPLICATION)-' + msg
        print(msg+'\n')
        self.presentation_layer(msg)
        return
                        ...
                        try:
                            ...
                            if command != 'POST' or command is None or command == ' ':
                                ...
                                if note_msg == '' or note_msg == ' ':
                                    ...
                                    self.application_layer(note_msg)
